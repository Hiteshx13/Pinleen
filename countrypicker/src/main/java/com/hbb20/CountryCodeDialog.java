...
class CountryCodeDialog {
    ...
    static {
        ...
        try {
            cursorDrawableResourceField = AppCompatTextView.class.getDeclaredField("mCursorDrawableRes");
    ...
    openCountryCodeDialog(final CountryCodePicker codePicker, final String countryNameCode) {
        ...
        final AppCompatEditText editText_search =  dialog.findViewById(R.id.editText_search);
        TextView textView_noResult = (TextView) dialog.findViewById(R.id.textView_noresult);
        LinearLayout dialogRoot =   dialog.findViewById(R.id.cardViewRoot);
